...
@Composable
fun ChiTietDonHang(navHostController: NavHostController, maHD: Int, viewModel: HoaDonViewModel = viewModel()) {
...
@Composable
fun ChiTiet(maHD: Int, viewModel: HoaDonViewModel = viewModel()) {
